...
if (state==1){
  ...
  if (intensity>=15){
    for (int i=1;i<=40;i++){
      ...
      RL1(X0+ri*cos(degtoradd(Oangle-133.43)),Y0+ri*sin(degtoradd(Oangle-133.43)),-7.5);
      RL3(X0+ri*cos(degtoradd(Oangle-43.43)),Y0+ri*sin(degtoradd(Oangle-43.43)),-7.5);
    ...
    for (int i=1;i<=40;i++){
      ...
      if (i<=20){
        ...
        RL1(X0+ri*cos(degtoradd(Oangle-133.43)),Y0+ri*sin(degtoradd(Oangle-133.43)),Z0);
        RL3(X0+ri*cos(degtoradd(Oangle-43.43)),Y0+ri*sin(degtoradd(Oangle-43.43)),Z0);
      }
      else {
        Z0=Z0-delz;
        LL2(X0+ri*cos(degtoradd(Oangle-90)),Y0+ri*sin(degtoradd(Oangle-90)),Z0);
