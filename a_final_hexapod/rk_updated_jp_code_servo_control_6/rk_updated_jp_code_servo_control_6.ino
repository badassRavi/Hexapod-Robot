...
if (datastate=="1"){
  ...
  if (intensity>=15 && (Oangle>=45 && Oangle<=135)){
    Oangle=90;
    for (int i=1;i<=40;i++){
      ri=ri-delr;
      LL2(X0+ri*cos(degtoradd(Oangle-90)),Y0+ri*sin(degtoradd(Oangle-90)),-7.5);
      RL1(-cr*cos(degtoradd(43.43))+ri*cos(degtoradd(Oangle+43.43)),cr*sin(degtoradd(43.43))+ri*sin(degtoradd(Oangle+43.43)),-7.5);
      RL3(cr*cos(degtoradd(43.43))+ri*cos(degtoradd(Oangle+133.43)),cr*sin(degtoradd(43.43))+ri*sin(degtoradd(Oangle+133.43)),-7.5);

      if (i<=20){
        Z0=Z0+delz;
        RL2(X0+ri*cos(degtoradd(Oangle-90)),Y0+ri*sin(degtoradd(Oangle-90)),Z0);
        LL1(-crx+ri*cos(degtoradd(Oangle+133.43)),cry+ri*sin(degtoradd(Oangle+133.43)),Z0);
        LL3(-cr*cos(degtoradd(43.43))+ri*cos(degtoradd(Oangle+43.43)),cr*sin(degtoradd(43.43))+ri*sin(degtoradd(Oangle+43.43)),Z0);
      }
      else {
        Z0=Z0-delz;
        RL2(X0+ri*cos(degtoradd(Oangle-90)),Y0+ri*sin(degtoradd(Oangle-90)),Z0);
    ...
    for (int i=1;i<=40;i++){
      ...
      LL1(-crx+ri*cos(degtoradd(Oangle+133.43)),cry+ri*sin(degtoradd(Oangle+133.43)),-7.5);
      LL3(-cr*cos(degtoradd(43.43))+ri*cos(degtoradd(Oangle+43.43)),cr*sin(degtoradd(43.43))+ri*sin(degtoradd(Oangle+43.43)),-7.5);

      if (i<=20){
        Z0=Z0+delz;
        LL2(X0+ri*cos(degtoradd(Oangle-90)),Y0+ri*sin(degtoradd(Oangle-90)),Z0);
        RL1(-cr*cos(degtoradd(43.43))+ri*cos(degtoradd(Oangle+43.43)),cr*sin(degtoradd(43.43))+ri*sin(degtoradd(Oangle+43.43)),Z0);
        RL3(cr*cos(degtoradd(43.43))+ri*cos(degtoradd(Oangle+133.43)),cr*sin(degtoradd(43.43))+ri*sin(degtoradd(Oangle+133.43)),Z0);
      }
      else {
        Z0=Z0-delz;
        LL2(X0+ri*cos(degtoradd(Oangle-90)),Y0+ri*sin(degtoradd(Oangle-90)),Z0);
